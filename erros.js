...
//const nome;
//SyntaxError: Missing initializer in const declaration (inicializador é o valor da constante)
//Erro de sintaxe. Constantes não podem ser declaradas sem valor!



console.log(texto);
//ReferenceError: texto is not defined
//Quer dizer que "texto" não existe ou não está definido em nosso documento.


console.log(nome);
//SyntaxError: missing ) after argument list
//O parênteses não foram fechados, está faltando o ")".
